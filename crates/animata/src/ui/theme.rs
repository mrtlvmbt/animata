...
// ---- colours (spec §1) ----
pub const PANEL_BG: Color32 = Color32::from_rgba_premultiplied(12, 15, 14, 184); // ~0.72 glass
pub const PANEL_BG_STRONG: Color32 = Color32::from_rgba_premultiplied(12, 15, 14, 189); // flyouts
pub const PANEL_STROKE: Color32 = Color32::from_rgba_premultiplied(255, 255, 255, 26); // 0.10 edge
pub const HAIRLINE: Color32 = Color32::from_rgba_premultiplied(255, 255, 255, 26); // dividers

pub const TEXT: Color32 = Color32::from_rgb(233, 236, 230); // primary
pub const TEXT_DIM: Color32 = Color32::from_rgba_premultiplied(233, 236, 230, 158); // secondary
pub const TEXT_FAINT: Color32 = Color32::from_rgba_premultiplied(233, 236, 230, 115); // caps labels
...
pub const ACCENT_FILL: Color32 = Color32::from_rgba_premultiplied(242, 166, 75, 41); // 0.16 backing
pub const ACCENT_LINE: Color32 = Color32::from_rgba_premultiplied(242, 166, 75, 128); // 0.50 frame

pub const GOOD_GREEN: Color32 = Color32::from_rgb(143, 209, 111); // population sparkline
pub const HOVER_FILL: Color32 = Color32::from_rgba_premultiplied(255, 255, 255, 18); // 0.07 hover
