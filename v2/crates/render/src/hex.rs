...
/// A tuned display constant, not load-bearing (render-space only). At 0.2 a full-HMAX (200) column
/// is 40 world-Y tall vs a hex circumradius of 1 — high relief still reads without the 80:1
/// "picket-fence" towers 0.4 produced on the diverse-relief terragen (tectonic/volcanic peaks).
pub const HEIGHT_SCALE: f32 = 0.2;
