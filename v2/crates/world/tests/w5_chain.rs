...
fn chain_is_deterministic_across_repeated_calls() {
    let a = classify_and_caps(CHAIN_SEED, W5_CHAIN_HMAX, W5_CHAIN_DIM, false, LandformFlags::from_five(false, false, false, false, false));
    let b = classify_and_caps(CHAIN_SEED, W5_CHAIN_HMAX, W5_CHAIN_DIM, false, LandformFlags::from_five(false, false, false, false, false));
...
fn caps_are_nonneg_and_bounded_at_prod_scale() {
    let fields = classify_and_caps(CHAIN_SEED, W5_CHAIN_HMAX, W5_CHAIN_DIM, false, LandformFlags::from_five(false, false, false, false, false));
