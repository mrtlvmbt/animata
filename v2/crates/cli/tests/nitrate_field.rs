...
fn p5_0_nitrate_inverse_to_oxygen_live_world() {
    ...
    for &seed in BIOME_RICH_SEEDS {
        let world = ProcgenWorld::new(64, HMAX, RESOURCE_BASE, seed ^ WORLD_SALT, None, false, false);
...
fn p5_0_nitrate_determinism_same_seed() {
    ...
    let world1 = ProcgenWorld::new(64, HMAX, RESOURCE_BASE, TEST_SEED ^ WORLD_SALT, None, false, false);
    let world2 = ProcgenWorld::new(64, HMAX, RESOURCE_BASE, TEST_SEED ^ WORLD_SALT, None, false, false);
...
fn p5_0_nitrate_generated_unconditionally() {
    ...
    let world = ProcgenWorld::new(64, HMAX, RESOURCE_BASE, 0xC0DE_CAFE ^ WORLD_SALT, None, false, false);
