...
[ $# -ge 1 ] || die "usage: sim-run.sh <scenario> [k=v ...]  (scenario: evo-stats|perf|v2-perf|multiseed|sweep|gridsweep|dprime-2c|dprime-3b|driver-emergence|hypoxia-verdict|settling-verdict|dol-verdict|composition-verdict)"
SCENARIO="$1"; shift
